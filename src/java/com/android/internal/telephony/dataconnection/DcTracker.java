...
import static com.android.internal.telephony.cdma.CDMAPhone.PROPERTY_CDMA_HOME_OPERATOR_ALPHA;
    ...
    private void createAllApnList() {
        ...
        if (operator != null) {
            ...
            if (cursor != null) {
                ...
                loge("createAllApnList: received NULL cursor from Phone#getContentResolver");
            }
        }

        // This is still needed for Sprint EVDO/1xRTT.
        String strAlphaCDMA = SystemProperties.get(PROPERTY_CDMA_HOME_OPERATOR_ALPHA, "");
        if (mAllApnSettings.isEmpty() && strAlphaCDMA.equalsIgnoreCase("Sprint")) {
